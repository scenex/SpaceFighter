...
namespace SpaceFighter.Logic
{
    ...
    public static class XboxExtensions
    {
        ...
        public static int RemoveAll2<T>(this System.Collections.Generic.List<T> list, Func<T, bool> match)
        {
            int numberRemoved = 0;
        ...
        public static bool Exists2<T>(this System.Collections.Generic.List<T> list, Func<T, bool> match)
        {
